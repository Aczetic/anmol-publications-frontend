...
const Book = () => {
  return <div className="bg-white w-15 min-w-25 h-45 md:w-35 md:min-w-35 md:h-60 text-xs text-sm flex flex-col gap rounded-sm overflow-hidden cursor-pointer">
    <div
      className="w-full h-full bg-cover bg-no-repeat bg-center"
      style={{ backgroundImage: `url(${gk1})` }}
    ></div>
    <div className="w-full h-10 bg-black truncate px-2 text-center flex items-center">
      <div className="w-full truncate">Knowledge Insights adfasdfadf</div>
    </div>
